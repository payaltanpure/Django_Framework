...
#then after user given value in input field then after submit button is clicked it goes to action tag written in form tag then it goes to app2/calculation 
